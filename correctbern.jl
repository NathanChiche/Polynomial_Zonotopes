...
"""
    univariate(m::AbstractMonomialLike, l::Integer, dom::IntervalArithmetic.Interval)

Compute the Bernstein coefficients of a univariate monomial over an IntervalArithmetic.Interval.

### Input

- `m`    -- monomial in one variable
- `l`    -- degree of the Bernstein polynomial
- `dom`  -- IntervalArithmetic.Interval domain of the Bernstein expansion
...
"""
function univariate(m::AbstractMonomialLike, l::Integer, dom::IntervalArithmetic.Interval{N}) where {N}
...
function univariate(t::AbstractTermLike, l::Integer, dom::IntervalArithmetic.Interval{N}) where {N}
    m = monomial(t)
    α = coefficient(t)
...
- `dom`  -- multi-dimensional IntervalArithmetic.Interval domain of the Bernstein expansion
...
```
"""
function multivariatehomemade(m::AbstractMonomialLike, l::AbstractVector{Int},
...
function multivariatehomemade(t::AbstractTermLike, l::AbstractVector{Int},
                      dom::IntervalBox{D,N}) where {D,N}
    m = monomial(t)
    α = coefficient(t)
...
multivariatehomemade(mo,[1,2],boitard)
IntervalArithmetic.inf(boitard)
